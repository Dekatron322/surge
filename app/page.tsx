    ...
    <>
      <main className="overflow-hidden">
        ...
        <div
          ...
          id="discover"
        >
          <div className="home__text-container hidden md:flex justify-center items-center w-full md:w-1/4">
            {/* Add flex styles */}
        ...
        <div className="relative z-0 max-w-[1200px] mx-auto" id="discover">
          <div className="md:hidden flex mt-10 padding-x ">
            <div className="home__text-container flex flex-col justify-center items-center w-full md:w-1/4">
              {/* Add flex styles */}
              <h1 className="md:text-5xl text-3xl font-extrabold self-center">
                100+
              </h1>
        ...
        <div className="mt-6 px-6 padding-x justify-center  flex xl:flex-row flex-row gap-10 relative z-0 max-w-[1300px] mx-auto">
